...
VALUES (
    CURRENT_USER(), NOW(), 'CLIENTE', 'INSERT', NEW.COD_CLI,
...
VALUES (
    CURRENT_USER(), NOW(), 'CLIENTE', 'UPDATE', OLD.COD_CLI,
...
VALUES (
    CURRENT_USER(), NOW(), 'CLIENTE', 'DELETE', OLD.COD_CLI,
...
VALUES (
    CURRENT_USER(), NOW(), 'DISTRITO', 'INSERT', NEW.COD_DIS,
    CONCAT('Nuevo registro: ',
        NEW.NOM_DIS)
);
...
VALUES (
    CURRENT_USER(), NOW(), 'DISTRITO', 'UPDATE', OLD.COD_DIS,
    CONCAT('Registro actualizado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'DISTRITO', 'DELETE', OLD.COD_DIS,
    CONCAT('Registro eliminado: ',
        OLD.NOM_DIS)
);
...
VALUES (
    CURRENT_USER(), NOW(), 'VENDEDOR', 'INSERT', NEW.COD_VEN,
    CONCAT('Nuevo registro: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'VENDEDOR', 'UPDATE', OLD.COD_VEN,
    CONCAT('Registro actualizado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'VENDEDOR', 'DELETE', OLD.COD_VEN,
    CONCAT('Registro eliminado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'PROVEEDOR', 'INSERT', NEW.COD_PRV,
    CONCAT('Nuevo registro: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'PROVEEDOR', 'UPDATE', OLD.COD_PRV,
    CONCAT('Registro actualizado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'PROVEEDOR', 'DELETE', OLD.COD_PRV,
    CONCAT('Registro eliminado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'PRODUCTO', 'INSERT', NEW.COD_PRO,
    CONCAT('Nuevo registro: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'PRODUCTO', 'UPDATE', OLD.COD_PRO,
    CONCAT('Registro actualizado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'PRODUCTO', 'DELETE', OLD.COD_PRO,
    CONCAT('Registro eliminado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'FACTURA', 'INSERT', NEW.NUM_FAC,
    CONCAT('Nuevo registro: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'FACTURA', 'UPDATE', OLD.NUM_FAC,
    CONCAT('Registro actualizado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'FACTURA', 'DELETE', OLD.NUM_FAC,
    CONCAT('Registro eliminado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'DETALLE_FACTURA', 'INSERT', NEW.NUM_FAC,
    CONCAT('Nuevo registro: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'DETALLE_FACTURA', 'UPDATE', OLD.NUM_FAC,
    CONCAT('Registro actualizado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'DETALLE_FACTURA', 'DELETE', OLD.NUM_FAC,
    CONCAT('Registro eliminado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'ORDEN_COMPRA', 'INSERT', NEW.NUM_OCO,
    CONCAT('Nuevo registro: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'ORDEN_COMPRA', 'UPDATE', OLD.NUM_OCO,
    CONCAT('Registro actualizado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'ORDEN_COMPRA', 'DELETE', OLD.NUM_OCO,
    CONCAT('Registro eliminado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'DETALLE_COMPRA', 'INSERT', NEW.NUM_OCO,
    CONCAT('Nuevo registro: ',
        NEW.CAN_DET)
);
...
VALUES (
    CURRENT_USER(), NOW(), 'DETALLE_COMPRA', 'UPDATE', OLD.NUM_OCO,
    CONCAT('Registro actualizado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'DETALLE_COMPRA', 'DELETE', OLD.NUM_OCO,
    CONCAT('Registro eliminado: ',
        OLD.CAN_DET)
);
...
VALUES (
    CURRENT_USER(), NOW(), 'ABASTECIMIENTO', 'INSERT', NEW.COD_PRV,
    CONCAT('Nuevo registro: ',
        NEW.PRE_ABA)
);
...
VALUES (
    CURRENT_USER(), NOW(), 'ABASTECIMIENTO', 'UPDATE', OLD.COD_PRV,
    CONCAT('Registro actualizado: ',
...
VALUES (
    CURRENT_USER(), NOW(), 'ABASTECIMIENTO', 'DELETE', OLD.COD_PRV,
    CONCAT('Registro eliminado: ',
        OLD.PRE_ABA)
);
